...
namespace JianpuEditor.Tests.Rendering
{
    public sealed class AccidentalRenderingTests
    {
        ...
        [Fact]
        public void RenderToBitmap_DynamicMarking_DoesNotThrow()
        {
            var measure = ScoreTestHelper.Measure(ScoreTestHelper.Note(1), ScoreTestHelper.Note(2));
            DynamicMarkingService.TrySetForNote(measure, 0, "mf");
        ...
        [Fact]
        public void RenderToBitmap_NaturalSign_DoesNotThrow()
        {
            var measure = ScoreTestHelper.Measure(
                ScoreTestHelper.Note(4, octave: 1),
                ScoreTestHelper.Note(5, octave: -1));
            measure.MelodyNotes[0].Accidental = AccidentalKind.Natural;
            measure.MelodyNotes[1].Accidental = AccidentalKind.Natural;
