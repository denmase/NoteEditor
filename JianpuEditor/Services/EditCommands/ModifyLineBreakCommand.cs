...
{
    internal sealed class ModifyLineBreakCommand : INoteEditCommand
    {
        ...
        public void Execute()
        {
            Apply(_newValue, _newValue ? "Line break added after measure" : "Line break removed");
        }
        ...
        private void Apply(bool value, string message)
        {
            ...
            _score.Measures[_measureIndex].ForcesLineBreak = value;
